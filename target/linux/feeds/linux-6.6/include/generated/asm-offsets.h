...
#define TSK_STACK_CANARY 1096 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2240 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 2952 /* offsetof(struct task_struct, thread.sctlr_user) */
...
#define MM_CONTEXT_ID 880 /* offsetof(struct mm_struct, context.id.counter) */
...
#define TRAMP_VALIAS -8625614848 /* TRAMP_VALIAS */
